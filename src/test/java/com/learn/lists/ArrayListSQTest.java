...
public class ArrayListSQTest {

	public ListSQ<Integer> newList() {
		return new ArrayListSQ<Integer>();
	}
	...
	public void testToStringAddLast() {
		...
		if (testList instanceof ArrayListSQ) {
			assertEquals(testList.toString(), "[0, 1, 2, 3, 4]");
		}
	}
	...
	public void testToStringAddFirst() {
		...
		if (testList instanceof ArrayListSQ) {
			assertEquals(testList.toString(), "[4, 3, 2, 1, 0]");
		}
	}
	...
	public void testToStringOneElement() {
		...
		if (testList instanceof ArrayListSQ) {
			assertEquals(testList.toString(), "[0]");
		}
	}
	...
	// TODO: If you are not using the bound method, comment this test out.
	@Test
	public void testBound() {

		/*
		 * [2, 3, 4, 5, 6, 8, n, 0] first = -1 last = 5
		 */

		Integer[] test = new Integer[8];

		assertEquals(7, ArrayListSQ.bound(-1, test));
		assertEquals(0, ArrayListSQ.bound(0, test));
		assertEquals(4, ArrayListSQ.bound(4, test));
		assertEquals(0, ArrayListSQ.bound(8, test));
		assertEquals(1, ArrayListSQ.bound(9, test));
