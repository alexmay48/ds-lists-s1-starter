...
public class ArrayListSQ<Type> implements ListSQ<Type> {
	 ...
	 * 
	 * Along with the provided methods, write any of your own methods
	 * here.
	 */
	 ...
	 * 
	 * Psuedocode:
	 * If position between 0 and length-1, return position
	 * If position is negative, subtract from length
	 * If position is greater than length-1, return position modula length
	 * 
	 * @param position
	 * @param backingStore
	 * @return the position in the backing array within the bounds of the backing array
	 */
